...
<nav class="navbar navbar-inverse">
	<div class="navbar-header">
		<a class="navbar-brand" href="{{ URL::to('members') }}">User Alert</a>
	</div>
	<ul class="nav navbar-nav">
		<li><a href="{{ URL::to('members') }}">View All Users</a></li>
	...
	@foreach($members as $key => $value)
		<tr>
			...
			<td>
				...
				<a class="btn btn-small btn-success" href="{{ URL::to('members/' . $value->id) }}">Show</a>
